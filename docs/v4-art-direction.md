...
| 原创 v4 包 | 默认包的 72 个 bullet 名、30 个 effect/player FX（含五组专属 option 与五组专属 Bomb）、11 个 laser、13 个 missile、10 个 pickup、五档心翼与 HUD 均为项目自有像素；敌弹已有实体核/骨白 keyline，玩家弹为身份色 keyline；分类图集使用确定性 shelf packing | 浏览器逐关检查强弹层级、主角状态身份和 Normal/Lunatic 密集弹幕负空间 |
