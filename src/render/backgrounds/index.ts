/**
 * The authored backgrounds.
 *
 * `../background.ts` is the engine — registry, `Background`, the shared noise
 ...
 * one means importing `../background`, and `src/content/` may not import from
