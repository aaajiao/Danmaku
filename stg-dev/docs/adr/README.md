...
| [EXT-2026-023：IN_BETWEEN 第二个 occurrence 的材料尾段与转交](EXT-2026-023-second-in-between-material-tail-transfer.md) | ACCEPTED | global8220..8519 cleanup-only tail；按slice close保留63个residue并零tick/event/RNG转给新material owner，最终drain另片 |
