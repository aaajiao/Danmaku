...
| [EXT-2026-012：首房 partial facts 的下一房 target](EXT-2026-012-first-continuation-room-target.md) | PROPOSED | 保留typed missing，只用available bias和一次Mulberry32 draw冻结ordinal 1 target；不接transition |
