...
| [EXT-2026-006：Canonical Run rolling 原始行为事实账本](EXT-2026-006-canonical-run-behavior-facts.md) | PROPOSED | accepted-tick 机械聚合、owner/request/commit 分栏、handoff 归属与显式 missing |
